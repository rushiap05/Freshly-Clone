function footer() {
    ...
    <div class="row container m-auto my-5">
        ...
        <div class="col">
            <p class="lead fw-bold">Learn More</p>
            <p>Plans & Menu</p>
            <p>Why Freshly?</p>
            <p>Gifts</p>
            <p>FAQs</p>
        ...
        <div class="col">
            <p class="lead fw-bold">Join Us</p>
            <div class="row" style="width: 180px;">
                <div class="col">
                    <img class="footer-img-social"
